...
create table SMARTCARD(Card_No varchar(10) primary key,Balance decimal NOT NULL DEFAULT 0,Card_Status varchar(15) NOT NULL DEFAULT 'Pending',Username varchar(20),Admin_Id int, 
